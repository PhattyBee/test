...
public class BilinkedIterator280<I> extends LinkedIterator280<I> implements BilinearIterator280<I>
{
	...
	{
		// TODO
		if (list.isEmpty()) throw new ContainerEmpty280Exception("The list is empty, can not move.");

		else{

			cur = list.tail;
			prev = ((BilinkedNode280<I>)list.tail).previousNode();
		}
	...
	{
		// TODO
		if (before()) throw new BeforeTheStart280Exception("The cursor is already the beginning of the list");
